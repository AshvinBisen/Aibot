...
const WalletManagement = () => {
  ...
  return (
    <div className="p-6 sm:p-8 space-y-8 text-white">
      ...
      {/* Page Heading */}
      {/* <div>
        <h1 className="text-2xl font-bold mb-1">Wallet Management</h1>
        <p className="text-gray-400">View balances, add funds, and manage transactions.</p>
      </div> */}

      {/* Wallet Info Cards */}
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-gradient-to-br from-gray-900 to-black rounded-2xl border border-gray-700 shadow-lg p-6">
          ...
          <div className="flex items-center justify-between bg-gray-800 rounded-xl p-3">
            ...
            <button onClick={copyToClipboard} className="p-2 hover:bg-gray-700 rounded-xl transition">
              <Copy size={18} />
            </button>
          </div>
        </div>
      ...
      {/* Add Funds + Withdraw */}
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-gradient-to-br from-gray-900 to-black rounded-2xl border border-gray-700 shadow-lg p-6 flex flex-col items-center space-y-4">
        ...
        <div className="bg-gradient-to-br from-gray-900 to-black rounded-2xl border border-gray-700 shadow-lg p-6 flex flex-col justify-between">
          <div>
          ...
          <button
            ...
            className="bg-red-600 hover:bg-red-700 transition text-white py-2 px-4 rounded-2xl flex items-center justify-center space-x-2"
          >
      ...
      <div className="bg-gradient-to-br from-gray-900 to-black rounded-2xl border border-gray-700 shadow-lg p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex space-x-2">
            <select
              className="bg-gray-800 text-white rounded-xl px-3 py-1 text-sm border border-gray-700"
              value={filter}
      ...
      >
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center">
          <div className="bg-gradient-to-br from-gray-900 to-black p-6 rounded-2xl shadow-lg w-full max-w-md border border-gray-700">
            <h3 className="text-xl font-semibold mb-4">Confirm Withdrawal</h3>
            <input
              type="text"
              placeholder="Enter amount"
              className="w-full p-3 rounded-xl bg-gray-800 border border-gray-700 mb-4 text-white"
            />
